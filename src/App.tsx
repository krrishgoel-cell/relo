...
function WaitlistForm() {
  ...
  if (status === "success") {
    return (
      <p className="mx-auto mt-8 max-w-md text-sm font-medium text-emerald-600">
    ...
    <div className="mx-auto mt-8 max-w-md">
      ...
      >
        ...
        <button
          ...
          className="whitespace-nowrap rounded-lg bg-blue-600 px-5 py-3 text-sm font-medium text-white transition-colors hover:bg-blue-700 disabled:opacity-60"
        >
  ...
  return (
    <div className="min-h-screen bg-paper text-ink">
      ...
      <main>
          ...
          <div className="grid gap-12 md:grid-cols-2 md:items-center">
            <div>
              <span className="inline-flex items-center gap-2 rounded-full border border-gray-200 bg-white px-3 py-1 text-xs font-medium text-gray-600">
                ...
                For people who move countries
              </span>
              <h1 className="mt-5 text-4xl font-bold leading-tight tracking-tight md:text-5xl">
                Don't lose your subscriptions when you move.
              </h1>
              <p className="mt-5 max-w-lg text-lg text-gray-600">
                A few subscriptions always come along for the ride when you
                move countries, whether you want them to or not: a leftover
                Apple ID balance, a Netflix plan still billing your old card,
                a Spotify subscription nobody remembers to cancel. Relo is
                the checklist for shutting all of it down cleanly, and the
                person who does it for you if you'd rather not.
              </p>
              <div className="mt-8 flex flex-wrap items-center gap-4">
                ...
                <a
                  href="#how-it-works"
                  className="rounded-lg border border-gray-300 px-5 py-3 text-sm font-medium text-ink transition-colors hover:border-gray-400"
                >
                  See how it works
                </a>
              </div>
              ...
              <div className="pt-4">
                <div className="flex items-center justify-between">
                  <p className="text-sm font-semibold">
                    Brazil <span className="text-gray-400">→</span> Portugal
                  </p>
                  <span className="text-xs text-gray-400">3 of 4 checked</span>
                </div>
                <div className="mt-3">
                  <ChecklistRow
        ...
        <section className="border-t border-gray-100 bg-white">
          <div className="mx-auto max-w-6xl px-6 py-20">
            <div className="grid gap-10 md:grid-cols-2 md:gap-16">
              <div>
                <SectionEyebrow>The part nobody warns you about</SectionEyebrow>
              ...
              <p className="text-lg text-gray-600">
                ...
                this out mid-move, right when they're also dealing with a new
                apartment, a new SIM card, and a dozen other things that
        ...
        <section id="coverage" className="border-t border-gray-100 bg-white">
          <div className="mx-auto max-w-6xl px-6 py-20">
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-8 md:p-12">
            <div className="grid gap-8 md:grid-cols-[1.2fr_1fr] md:items-center">
              ...
              <div className="flex md:justify-end">
                <a
                  href="#checklist"
                  className="rounded-lg bg-ink px-5 py-3 text-sm font-medium text-white transition-colors hover:bg-black"
                >
                  Ask us to handle it
                </a>
              </div>
        ...
        <section id="checklist" className="border-t border-gray-100 bg-white">
          <div className="mx-auto max-w-6xl px-6 py-20 text-center">
            <h2 className="text-3xl font-bold tracking-tight md:text-4xl">
              Moving soon? Start your subscription checklist before you pack.
            </h2>
      ...
      <footer className="border-t border-gray-100">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-6 py-8 text-sm text-gray-500 md:flex-row">
          <p>Relo, built for the subscriptions that don't survive a move.</p>
